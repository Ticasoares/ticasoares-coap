...
class Temperatura(Resource):
    def __init__(self, name="TemperaturaResource", coap_server=None):
        super(Temperatura, self).__init__(name, coap_server, visible=True,
    ...
    def render_PUT(self, request):
        if (request.payload == 'randomTemperature'):
           self.payload = str(randint(0,45))
        else:
